...
<body>
    <main>
        ...
        <div align="center">
			...
			<a href="https://gorillaz.pocoloco-digital.com/">
				<img src="./assets/banner-crypto-gorillaz.jpg" alt="Crypto GorillaZ - Banner XS" class="app-header-image">
			</a>
        ...
        <ul>
            ...
            <li>
                <a href="javascript:Telegram.WebApp.openLink('https://gorillaz.pocoloco-digital.com/');">Open link in external browser</a>
            </li>
            <li>
    ...
    <script>
        ...
        function showPopup() {
            Telegram.WebApp.showPopup({
                ...
                buttons: [
                    {id: 'link', type: 'default', text: 'Open gorillaz.pocoloco-digital.com'},
                    {type: 'cancel'},
                ]
            }, function(btn) {
                if (btn === 'link') {
                    Telegram.WebApp.openLink('https://gorillaz.pocoloco-digital.com/');
                }
            });
        };
